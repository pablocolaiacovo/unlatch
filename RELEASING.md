...
- **Pull requests are squash-merged.** The repository allows squash merges only (merge commits and
  ...
  line. Write it as a user-facing, imperative sentence — "Unlock PDFs from a Finder
  Quick Action", not "wip: fix stuff" and not a dump of commit subjects. If you would not want to read
